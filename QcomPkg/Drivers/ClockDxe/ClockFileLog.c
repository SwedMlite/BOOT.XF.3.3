...
--------   ---     ----------------------------------------------------------
01/08/18   op      Init gnEBSClockLogSetting to fix Clocks'state dumping issue
...
/*===========================================================================
                    GLOBAL VARIABLE
=============================================================================*/
static BDS_CLOCKLOG_STATE   gnEBSClockLogSetting = BDSClockLogStateDisable;
...
EFI_STATUS ClockFileLog_GetEBSClockLogSetting(BDS_CLOCKLOG_STATE *eLogState)
{
  ...
  *eLogState = BDSClockLogStateDisable;
  ...
  if (eStatus != EFI_SUCCESS) {
    eClockLogMode = BDSClockLogStateDisable;
    DEBUG(( EFI_D_INFO, "ClockDxe: Can't dump Clock's state. Please set your choice as following: \r\n"));
    DEBUG(( EFI_D_INFO, ">>> Select <CLOCK Menu> under BDS Menu  \r\n", __FUNCTION__, eStatus));
    DEBUG(( EFI_D_INFO, ">>> Select <Toggle Logging Clocks states> \r\n", __FUNCTION__, eStatus));
    DEBUG(( EFI_D_INFO, ">>> Select <1> to dump clock state to UART \r\n", __FUNCTION__, eStatus));
  }
