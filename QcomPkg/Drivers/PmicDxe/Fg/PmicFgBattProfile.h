...
#define BATT_THERM_PULL_UP_LOW			30		// 30K ohm
#define BATT_THERM_PULL_UP_MID			100		// 100K ohm
#define BATT_THERM_PULL_UP_HIGH			400		// 400K ohm
#define BATT_THERM_PULL_UP_LOW_MAX		54		// 54K ohm
#define BATT_THERM_PULL_UP_MID_MAX		200		// 200K ohm
...
typedef struct _FgBattThermCoff{
  ...
  UINT32 ThermC3Coeff;
  UINT32 ThermC5Coeff;
  UINT32 ThermCenterOffset;
  UINT32 ThermPullup;
}FgBattThermCoff;

typedef struct _FgRslowCoff{
	UINT32 RslowNormalCoeff;
	UINT32 RslowLowCoeff;
}FgRslowCoff;
