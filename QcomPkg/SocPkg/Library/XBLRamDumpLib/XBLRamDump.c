...
* 
*/ 
VOID XBLRamDumpMain( void * shared_functions_table_ptr )
{
  ...
  boot_shared_functions_init(shared_functions_table_ptr);
  ...
  if (display_flag && boot_check_display_allowed())
  {
