...
--------   ---     ------------------------------------------------------------
01/22/19   yps     Add ramdump entry function parameter
...
static void sbl_sahara_unrecoverable_error_handler(void)
{
  boot_shared_functions_type * shared_functions_table = NULL;
  ...
  */
...
#else
  shared_functions_table = boot_get_shared_function_table();
  ...
  ((void (*)())(uintnt)(SCL_RAMDUMP_CODE_BASE))(shared_functions_table); 
#endif
}
