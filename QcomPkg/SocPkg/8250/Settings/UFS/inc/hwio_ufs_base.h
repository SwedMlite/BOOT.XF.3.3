...
/*
  ...
  $Header: //components/rel/boot.xf/3.2/QcomPkg/SocPkg/8250/Settings/UFS/inc/hwio_ufs_base.h#4 $
  $DateTime: 2018/12/28 12:03:57 $
  $Author: pwbldsvc $
...
#define UFS_MEM_UFS_REG_BASE_USED                                                    0x280c
...
#define HWIO_UFS_MEM_PARAM0_RMSK                                                           0x73
#define HWIO_UFS_MEM_PARAM0_IN          \
        in_dword_masked(HWIO_UFS_MEM_PARAM0_ADDR, HWIO_UFS_MEM_PARAM0_RMSK)
...
#define HWIO_UFS_MEM_CRYPTOCAP_n_OFFS(n)                                             (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000104 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_UAWMn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000500 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_UARMn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000600 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_TXUCn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000700 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_RXUCn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000800 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_DFCn_OFFS(n)                                         (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000900 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_TRLUTn_OFFS(n)                                       (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000a00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_TMRLUTn_OFFS(n)                                      (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000b00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_REG_OCSCn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000c00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_TX_BUFFn_OFFS(n)                                         (UFS_MEM_UFS_REG_BASE_OFFS + 0x00000d00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_RX_BUFFn_OFFS(n)                                         (UFS_MEM_UFS_REG_BASE_OFFS + 0x00001500 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_DESC_RAMn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00001900 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_PRDT_RAMn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00001b00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_RESP_RAMn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00001c00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_EDTL_RAMn_OFFS(n)                                        (UFS_MEM_UFS_REG_BASE_OFFS + 0x00001d00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_DBG_RD_ICE_CNXT_RAMn_OFFS(n)                                    (UFS_MEM_UFS_REG_BASE_OFFS + 0x00001e00 + 0x4 * (n))
...
#define HWIO_UFS_MEM_HW_EVENT_MUX_SELECT_REGn_OFFS(n)                                (UFS_MEM_UFS_REG_BASE_OFFS + 0x00002400 + 0x4 * (n))
...
#define HWIO_UFS_MEM_HW_H8_ENTER_CNT_IN          \
        in_dword_masked(HWIO_UFS_MEM_HW_H8_ENTER_CNT_ADDR, HWIO_UFS_MEM_HW_H8_ENTER_CNT_RMSK)
...
#define HWIO_UFS_MEM_SW_H8_ENTER_CNT_IN          \
        in_dword_masked(HWIO_UFS_MEM_SW_H8_ENTER_CNT_ADDR, HWIO_UFS_MEM_SW_H8_ENTER_CNT_RMSK)
...
#define HWIO_UFS_MEM_SW_AFTER_HW_H8_ENTER_CNT_IN          \
        in_dword_masked(HWIO_UFS_MEM_SW_AFTER_HW_H8_ENTER_CNT_ADDR, HWIO_UFS_MEM_SW_AFTER_HW_H8_ENTER_CNT_RMSK)
...
#define HWIO_UFS_MEM_HW_H8_EXIT_CNT_IN          \
        in_dword_masked(HWIO_UFS_MEM_HW_H8_EXIT_CNT_ADDR, HWIO_UFS_MEM_HW_H8_EXIT_CNT_RMSK)
...
#define HWIO_UFS_MEM_SW_H8_EXIT_CNT_IN          \
        in_dword_masked(HWIO_UFS_MEM_SW_H8_EXIT_CNT_ADDR, HWIO_UFS_MEM_SW_H8_EXIT_CNT_RMSK)
...
#define HWIO_UFS_MEM_QTIMER_31_0_ADDR                                                (UFS_MEM_UFS_REG_BASE      + 0x00002808)
#define HWIO_UFS_MEM_QTIMER_31_0_OFFS                                                (UFS_MEM_UFS_REG_BASE_OFFS + 0x00002808)
#define HWIO_UFS_MEM_QTIMER_31_0_RMSK                                                0xffffffff
#define HWIO_UFS_MEM_QTIMER_31_0_IN          \
        in_dword_masked(HWIO_UFS_MEM_QTIMER_31_0_ADDR, HWIO_UFS_MEM_QTIMER_31_0_RMSK)
#define HWIO_UFS_MEM_QTIMER_31_0_INM(m)      \
        in_dword_masked(HWIO_UFS_MEM_QTIMER_31_0_ADDR, m)
#define HWIO_UFS_MEM_QTIMER_31_0_QTIMER_31_0_BMSK                                    0xffffffff
#define HWIO_UFS_MEM_QTIMER_31_0_QTIMER_31_0_SHFT                                           0x0

#define HWIO_UFS_MEM_QTIMER_55_32_ADDR                                               (UFS_MEM_UFS_REG_BASE      + 0x0000280c)
#define HWIO_UFS_MEM_QTIMER_55_32_OFFS                                               (UFS_MEM_UFS_REG_BASE_OFFS + 0x0000280c)
#define HWIO_UFS_MEM_QTIMER_55_32_RMSK                                                 0xffffff
#define HWIO_UFS_MEM_QTIMER_55_32_IN          \
        in_dword_masked(HWIO_UFS_MEM_QTIMER_55_32_ADDR, HWIO_UFS_MEM_QTIMER_55_32_RMSK)
#define HWIO_UFS_MEM_QTIMER_55_32_INM(m)      \
        in_dword_masked(HWIO_UFS_MEM_QTIMER_55_32_ADDR, m)
#define HWIO_UFS_MEM_QTIMER_55_32_QTIMER_55_32_BMSK                                    0xffffff
#define HWIO_UFS_MEM_QTIMER_55_32_QTIMER_55_32_SHFT                                         0x0
