...
$(OUTPUT_DIR)/image/core/target/$(TARGET_ID)/cpr_image_target.obj : $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target.c
