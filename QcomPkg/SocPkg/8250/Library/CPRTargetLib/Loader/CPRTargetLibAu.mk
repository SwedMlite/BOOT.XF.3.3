...
INC =  \
    ...
    -I$(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID) \
...
$(OUTPUT_DIR)/cpr_voltage_plan_$(TARGET_ID).obj : $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Settings/CPR/$(VAR)/cpr_voltage_plan_$(TARGET_ID).c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Settings/CPR/$(VAR)/cpr_voltage_plan_$(TARGET_ID).c

$(OUTPUT_DIR)/image/xbl/target/$(TARGET_ID)/cpr_image_target_init.obj : $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_init.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_init.c
...
$(OUTPUT_DIR)/image/xbl/target/$(TARGET_ID)/cpr_image_target.obj : $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_au.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/SocPkg/$(CHIP_ID)/Library/CPRTargetLib/image/xbl/target/$(TARGET_ID)/cpr_image_target_au.c

$(OUTPUT_DIR)/Library/CPRLib/image/xbl/src/cpr_image.obj : $(WORKSPACE)/QcomPkg/Library/CPRLib/image/xbl/src/cpr_image_au.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/Library/CPRLib/image/xbl/src/cpr_image_au.c
