...
/*
  ...
  $Header: //components/rel/boot.xf/3.2/QcomPkg/Include/ClockDefs.h#2 $
  $DateTime: 2019/05/21 19:48:18 $
  $Author: pwbldsvc $
...
typedef struct ClockQueryResult
{
  ...
  union
  {
    ...
    boolean             bDFSEnabled;        /* CLOCK_QUERY_DFS_ENABLED */
...
typedef struct
{
  ClockIdType       ClockId;              /* clock ID */
  ClockDomainIdType ClockDomainId;        /* associated clock domain ID */
  uint32            nDebugId;             /* QDSS clock debug ID */
