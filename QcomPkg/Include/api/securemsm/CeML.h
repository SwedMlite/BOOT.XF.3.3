...
typedef enum
{
  ...
  CEML_HASH_ALGO_SHA224             = 0x2,
  CEML_HASH_ALGO_SHA256             = 0x3,
  CEML_HASH_ALGO_SHA384             = 0x4,
  CEML_HASH_ALGO_SHA512             = 0x5,
...
typedef enum 
{
  ...
  CEML_CIPHER_MODE_GCM              = 0x7,
  CEML_CIPHER_MODE_INVALID          = 0xFF
} CeMLCipherModeType;
