...
*
*
*  \n &copy; Copyright 2014-2019 QUALCOMM Technologies Inc, All Rights Reserved
*/
...
typedef enum
{
  PM_HAPTICS_LRA_HIGH_Z_HIGHZ_OPT1, /*0 LRA period (ZXD), 1/4 LRA period (QWD)*/
  PM_HAPTICS_LRA_HIGH_Z_HIGHZ_OPT2, /*1 LRA period (ZXD), 3/8 LRA period (QWD)*/
...
typedef enum
{
  PM_HAPTICS_LRA_RES_CALIB_4LRA_PERIODS,  /*AFTER EVERY 4 LRA PERIOD*/
  PM_HAPTICS_LRA_RES_CALIB_8LRA_PERIODS,  /*AFTER EVERY 8 LRA PERIOD*/
  PM_HAPTICS_LRA_RES_CALIB_16LRA_PERIODS, /*AFTER EVERY 16 LRA PERIOD*/
  PM_HAPTICS_LRA_RES_CALIB_32LRA_PERIODS, /*AFTER EVERY 32 LRA PERIOD*/
  PM_HAPTICS_LRA_RES_CALIB_64LRA_PERIODS, /*AFTER EVERY 64 LRA PERIOD*/
  PM_HAPTICS_LRA_RES_CALIB_128LRA_PERIODS,/*AFTER EVERY 128 LRA PERIOD*/
  PM_HAPTICS_LRA_RES_CALIB_256LRA_PERIODS,/*AFTER EVERY 256 LRA PERIOD*/
...
PARAMETERS
   ...
   3) Name: calib_eop
        - Calibrate at the end of pattern. TRUE enables calibration at the end of pattern. FALSE otherwise
   4) Name: qwd_drive_duration
        - Duration of high-Z time based on LRA resoanace technique. Refer #pm_haptics_lra_high_z_type 
   5) Name: cal_duration
        - Numer of LRA period for calibration duration. 
   6) Name: auto_res_mode
...
*/
pm_err_flag_type 
pm_haptics_auto_res_cfg(uint32  pmic_chip, pm_haptics_lra_res_calib_type calib_period, boolean calib_eop, pm_haptics_lra_high_z_type qwd_drive_duration, 
