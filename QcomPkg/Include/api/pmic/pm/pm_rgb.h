...
/*===========================================================================
FUNCTION  pm_rgb_chgr_led_config

DESCRIPTION
  This function enables home row led for charger or independent control
...
PARAMETERS
   ...
   3) Name: led_mask
      - Mask of the RGB segments to enable/disable (PM_RGB_SEGMENT_*).
   4) Name: enable
      - Boolean to enable/disable the indicated LED for charger
