...
Copyright 2010-2015, 2017-2019 Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
* 
* @brief
*  Set the page table base address in TTBR0i_EL1.
* 
* @par Dependencies
*  None
* 
...
* 
*/
void mmu_set_page_table_base(uint64 addr);
