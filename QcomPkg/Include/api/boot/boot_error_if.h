...
Copyright 2007-2012, 2014-2019 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
============================================================================*/
...
typedef enum
{
  ...
  BL_ERR_EXT_HEAP_DEINIT_FAIL                = 0x0090,
  
  BL_ERR_MMU_INVALID_ADDRESS                 = 0x0091,
  BL_ERR_MMU_INVALID_SIZE                    = 0x0092,
