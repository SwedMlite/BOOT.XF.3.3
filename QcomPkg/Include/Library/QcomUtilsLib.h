/** @file QcomLib.h
  ...
  Copyright (c) 2013, 2015, 2018, Qualcomm Technologies, Inc. All rights reserved. 
...
/**
  Launch image/app from FV using device name and path. 

  @param  Char8* Name:    Image Device name/path to be loaded
  @param  Argv   Array of strings that represent the options if 
                 need to pass for an App. 
