...
--------   ---     ------------------------------------------------------------
06/19/19   AY      Added a flag in TGT flags of BAM specific to CMD Unlock case of APPS CE BAM
...
#define BAM_TGT_CMD_UL_CHCK            0X100/**< To skip eot check for Cmd des of Crypto BAM,work around for BAM stall issue specific to CE BAM >**/
