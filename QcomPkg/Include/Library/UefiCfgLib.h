...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 02/01/19   am      GetMemoryRegionInfoByAddress support
...
typedef EFI_STATUS (*GET_MEM_INFO_BY_ADDRESS) (UINT64 RegionBaseAddress, MemRegionInfo* MemRegions);
...
/**
  ...
  @param  RegionBaseAddress      Memory base address of region in configuration file
...
EFI_STATUS
EFIAPI
GetMemRegionInfoByAddress (IN UINT64 RegionBaseAddress, IN OUT MemRegionInfo* MemoryRegion);
