/** @file BMPLib.h
 ...
 Copyright (c) 2015,2019 Qualcomm Technologies, Inc.  All Rights Reserved.<BR>
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 01/28/19   kpa     Added FvNameGuid parameter to DrawBmpFile
 ...
 * @param  FvNameGuid   Optional FvGuid for FileName.
 * Note : If FvNameGuid is not NULL, FileName to not contain fv path.
 *
