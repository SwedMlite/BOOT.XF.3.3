...
{
   // Use MDSS_MDP V6.0.0 as the base info
   HAL_MDP_ReadHardwareInfo_6_0_0(psHwInfo, psMdpHwInfo);
}
...
static void HAL_MDP_ConfigUBWCSettings()
{
  ...
  // Update the UBWC Ctrl_2 revision
  ...
  // Update the UBWC Prediction mode
