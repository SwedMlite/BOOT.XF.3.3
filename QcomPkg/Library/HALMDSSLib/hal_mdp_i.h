...
typedef struct _HAL_MDP_QoSLutInfo
{
  ...
  uint32          uCreqLutValue_0;               /* CReq LUT value -- upper   */
  uint32          uCreqLutValue_1;               /* CReq LUT value -- lower   */
} HAL_MDP_QoSLutInfo;
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SwapMacroTileColorComponent_6_0_0()
*/
/*!
* \brief
...
*
****************************************************************************/
uint32 HAL_MDP_SwapMacroTileColorComponent_6_0_0(HAL_MDP_PixelFormatType ePixelFormat, uint32 uPatternValue);

/****************************************************************************
*
** FUNCTION: HAL_MDP_SSPP_SetQosConfig_6_0_0()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_MDP_SSPP_SetQosConfig_6_0_0 (HAL_MDP_SourcePipeId              eSourcePipe,
                                      HAL_MDP_TrafficCtrl_LatencyType   eLatency,
                                      HAL_MDP_Qos_ConfigType           *psQoSInfo,
                                      uint32                            uFlags);
