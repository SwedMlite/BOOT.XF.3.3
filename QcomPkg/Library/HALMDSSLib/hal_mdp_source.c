                                         ...
                                         uint32                  uFlags)
{
   if (NULL!= pgsMdpHwInfo->psSSPPQoSInfo)
   {
      ...
      if (pgsMdpHwInfo->psSSPPQoSInfo->pLinearQoSInfo)
      {
         ...
         out_dword(HWIO_MDP_VP_0_VIG_0_SSPP_SAFE_LUT_ADDR   + uRegisterOffset, pgsMdpHwInfo->psSSPPQoSInfo->pLinearQoSInfo->uSafeLutValue);
         out_dword(HWIO_MDP_VP_0_VIG_0_SSPP_CREQ_LUT_0_ADDR + uRegisterOffset, pgsMdpHwInfo->psSSPPQoSInfo->pLinearQoSInfo->uCreqLutValue_0);
         out_dword(HWIO_MDP_VP_0_VIG_0_SSPP_CREQ_LUT_1_ADDR + uRegisterOffset, pgsMdpHwInfo->psSSPPQoSInfo->pLinearQoSInfo->uCreqLutValue_1);
      }
   }
}
