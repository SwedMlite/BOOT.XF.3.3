...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/framework/src/pm_loader_init.c#6 $
$Author: pwbldsvc $
...
pm_err_flag_type pm_driver_init( void )
{
    ...
    {
       err_flag = pm_comm_write_byte_mask(0, PMIO_PON_PERPH_RB_SPARE_ADDR, PON_PERPH_RB_SPARE_DRIVER_INIT_MASK, PON_PERPH_RB_SPARE_DRIVER_INIT_MASK); 
    }
