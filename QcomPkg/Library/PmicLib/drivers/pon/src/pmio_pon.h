...
/*
  ...
  $Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/drivers/pon/src/pmio_pon.h#3 $
  $Author: pwbldsvc $
...
#define PMIO_PON_GEN2_SMPL_CTL_ADDR                                          (PON_BASE      + 0x0000007F)
#define PMIO_PON_GEN2_SMPL_EN_BMSK                                           0x80
