...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/drivers/ibb/src/pm_ibb_driver.c#2 $
$Author: pwbldsvc $
...
static pm_ibb_register_info_type  ibb_reg[1]=
{
   {0xDC00, 0x008, 0x040, 0x041, 0x045, 0x046, 0x058, 0x05A}
};
...
{
  if((pmic_index < PM_MAX_NUM_PMICS) && 
     (pm_ibb_data_arr[pmic_index] !=NULL))
  {
