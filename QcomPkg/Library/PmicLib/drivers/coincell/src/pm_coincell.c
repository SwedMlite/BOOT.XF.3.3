...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/drivers/coincell/src/pm_coincell.c#3 $ 
...
)
{
    ...
    err_flag = pm_comm_write_byte_mask(coincell_ptr->comm_ptr->slave_id, reg, 0x80, (pm_register_data_type)((enable)<<7));
...
)
{
    ...
    err_flag   = pm_comm_read_byte(coincell_ptr->comm_ptr->slave_id, reg_coincell_en_ctl, &en_ctl_val);
...
)
{
    ...
    err_flag   = pm_comm_write_byte_mask(coincell_ptr->comm_ptr->slave_id,reg_coincell_coin_chg_rset,0x03,coin_chg_rset_value);
...
)
{
    ...
    err_flag   = pm_comm_write_byte_mask(coincell_ptr->comm_ptr->slave_id,reg_coincell_coin_chg_vset,0x03,coin_chg_vset_value);
