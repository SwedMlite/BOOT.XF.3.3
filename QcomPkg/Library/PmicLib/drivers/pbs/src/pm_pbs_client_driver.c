...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/drivers/pbs/src/pm_pbs_client_driver.c#2 $
$Author: pwbldsvc $
...
static pm_pbs_client_register_info_type pbs_client_reg[1] = 
{
