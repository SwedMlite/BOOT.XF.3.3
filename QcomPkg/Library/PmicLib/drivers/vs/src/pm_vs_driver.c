...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/drivers/vs/src/pm_vs_driver.c#2 $
$Author: pwbldsvc $
...
{
   0x8000, 0x100, 0x008, 0x00B, 0x039, 0x040, 0x041, 0x042, 0x043, 
    0x045, 0x046, 0x0A0, 0x047, 0x050, 0x051, 0x063, 0x06B, 0x000,
    0x088, 0x000, 0x000, 0x000
};
