 ...
 *  \brief  ipwm.h 
 *  \details  
 *  \n &copy; Copyright (c) 2012-2018 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/drivers/pwm/src/pm_pwm_driver.h#2 $
$Author: pwbldsvc $
