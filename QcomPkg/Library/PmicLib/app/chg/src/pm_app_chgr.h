...
$Header: //components/rel/boot.xf/3.2/QcomPkg/Library/PmicLib/app/chg/src/pm_app_chgr.h#2 $
$Author: pwbldsvc $
...
typedef struct
{
    ...
    pm_batt_id_pull_up_type                          pull_up;
...
typedef struct
{
    int16 afp_too_hot_threshold; // in the unit of Celsius
    boolean enable_hot_afp_trigger;
    int16 afp_too_cold_threshold; // in the unit of Celsius
    boolean enable_cold_afp_trigger;
} pm_sbl_schg_afp_type;
...
typedef struct {
  uint32 batt_id_min;
  uint32 batt_id_max;
}pm_sbl_schg_batt_id_range_type;
...
typedef struct
{
   ...
   pm_sbl_schg_batt_id_range_type     batt_id_range;
 ...
 *
 * @description
 *    This function configures afp thresholds and enable/disable it based on the configure setting.
 * 
 * @param 
 *     None
 * 
...
/**
 * @description
 *    This function do the configuration for the scenario of boot up without battery. 
 * @return 
 *     pm_err_flag_type
 * 
 * @dependency
