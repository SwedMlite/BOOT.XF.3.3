...
/*
  ...
  $Header: //components/rel/boot.xf/3.2/QcomPkg/Library/SPMILib/src/core/hal/hoya/hw/v5p1/PmicArbCoreHwio.h#1 $
  $DateTime: 2018/11/20 15:05:41 $
  $Author: pwbldsvc $
...
#define HWIO_PMIC_ARB_SW_RST_CTRL_IN(x)      \
        in_dword(HWIO_PMIC_ARB_SW_RST_CTRL_ADDR(x))
...
#define HWIO_PMIC_ARB_PRIORITIESn_PORT_PRIORITY_BMSK                                               0x7
...
#define HWIO_PMIC_ARB_PVC_INTF_CTL_IN(x)      \
        in_dword(HWIO_PMIC_ARB_PVC_INTF_CTL_ADDR(x))
...
#define HWIO_PMIC_ARB_PVC_INTF_STATUS_IN(x)      \
        in_dword(HWIO_PMIC_ARB_PVC_INTF_STATUS_ADDR(x))
...
#define HWIO_PMIC_ARB_VRM_S_INTF_STATUS_IN(x)      \
        in_dword(HWIO_PMIC_ARB_VRM_S_INTF_STATUS_ADDR(x))
...
#define HWIO_PMIC_ARB_VRM_S_PORT_CTL_IN(x)      \
        in_dword(HWIO_PMIC_ARB_VRM_S_PORT_CTL_ADDR(x))
...
#define HWIO_PMIC_ARB_VRM_S_PORT_STATUS_IN(x)      \
        in_dword(HWIO_PMIC_ARB_VRM_S_PORT_STATUS_ADDR(x))
...
#define QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS       0x00000000

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_ADDR(x)                 ((x) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000000)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OFFS                    (0x00000000)
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_OPCODE_SHFT                    0x1
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_PRIORITY_BMSK                  0x1
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD0_PRIORITY_SHFT                  0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_ADDR(x)                 ((x) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000004)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_OFFS                    (0x00000004)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_RMSK                          0x7f
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_BYTE_CNT_SHFT                  0x4
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_SID_BMSK                       0xf
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD1_SID_SHFT                       0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_ADDR(x)                 ((x) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000008)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_OFFS                    (0x00000008)
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD2_PPID_SHFT                      0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDR(x)                 ((x) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x0000000c)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_OFFS                    (0x0000000c)
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CMD3_ADDRESS_SHFT                   0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_ADDR(x)               ((x) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000010)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_OFFS                  (0x00000010)
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_CONFIG_IRQ_EN_SHFT                  0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_ADDR(x)               ((x) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000014)
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_OFFS                  (0x00000014)
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DROPPED_SHFT                 0x3
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DENIED_BMSK                  0x4
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DENIED_SHFT                  0x2
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_FAILURE_BMSK                 0x2
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_FAILURE_SHFT                 0x1
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DONE_BMSK                    0x1
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_STATUS_DONE_SHFT                    0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_ADDR(base,g)          ((base) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000018 + 0x4 * (g))
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_OFFS(base,g)          (0x00000018 + 0x4 * (g))
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_WDATAg_DATA_SHFT                    0x0

#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_ADDR(base,h)          ((base) + QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_REG_BASE_OFFS + 0x00000038 + 0x4 * (h))
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_OFFS(base,h)          (0x00000038 + 0x4 * (h))
...
#define HWIO_QDSS_AOSS_APB_AOSS_PMIC_ARB_DEBUG_CSR_PMIC_ARB_DEBUG_SPMI_CHNL_RDATAh_DATA_SHFT                    0x0

/*----------------------------------------------------------------------------
 * MODULE: MGPIx
 *--------------------------------------------------------------------------*/

#define MGPI1_REG_BASE                   0x0C270000
...
#define HWIO_MGPI1_MUX_SEL_BMSK                 0x7
