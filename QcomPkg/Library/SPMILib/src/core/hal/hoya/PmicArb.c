 ...
 * $Header: //components/rel/boot.xf/3.2/QcomPkg/Library/SPMILib/src/core/hal/hoya/PmicArb.c#2 $
 * $Change: 17668901 $ 
 * 
 *                              Edit History
 * Date     Description
    ...
    *bytesTransacted = 0;    
    ...
    switch(cmd)
    {
        ...
        case PMIC_ARB_CMD_EXTENDED_REG_WRITE_LONG:
            doWrite = TRUE;
            irqStatus = SPMI_HWIO_IN( HWIO_SPMI_PROTOCOL_IRQ_STATUS_ADDR( base_addr ) );
