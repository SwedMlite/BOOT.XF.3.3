 ...
 * 
 * $DateTime: 2019/06/24 23:13:07 $
 * $Header: //components/rel/boot.xf/3.2/QcomPkg/Library/SPMILib/src/core/hal/hoya/SpmiMaster.c#2 $
 * $Change: 19647045 $ 
 * 
...
static Spmi_Result loadMin(SpmiDevInfo *pDev, uint8 masterId)
{
    ...
    SPMI_HWIO_OUT_SET( HWIO_SPMI_CFG_REG_ADDR( base_addr ), HWIO_SPMI_CFG_REG_ASYNC_SSC_DET_INT_DIS_BMSK );
    SPMI_HWIO_OUT_SET( HWIO_SPMI_CFG_REG_ADDR( base_addr ), HWIO_SPMI_CFG_REG_ARB_UNKNOWN_EN_BMSK );
    SPMI_HWIO_OUT_SET( HWIO_SPMI_CFG_REG_ADDR( base_addr ), HWIO_SPMI_CFG_REG_SSC_WINDOW_EN_BMSK ); // should be after??
    SPMI_HWIO_OUT_SET( HWIO_SPMI_CFG_REG_ADDR( base_addr ), HWIO_SPMI_CFG_REG_SSC_DET_INT_DIS_BMSK );
    SPMI_HWIO_OUT_SET( HWIO_SPMI_CFG_REG_ADDR( base_addr ), HWIO_SPMI_CFG_REG_FORCE_ARB_AFTER_MASTER_TO_BMSK );//not initially tested
