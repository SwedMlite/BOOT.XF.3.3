 ...
 *
 * $DateTime: 2019/10/28 19:51:52 $
 * $Header: //components/rel/boot.xf/3.2/QcomPkg/Library/CPRLib/image/xbl/src/cpr_image.c#5 $
 * $Change: 21132559 $
 */
#include <stdlib.h>
#include "cpr_image.h"
...
{
    cpr_domain_id domain =
        cpr_image_target_railway_rail_to_cpr_domain(railwayRailId);
    cpr_domain_info info =
    {
        CPR_DOMAIN_TYPE_MODE_BASED,
        {
            cpr_image_target_railway_corner_to_cpr_mode(railwayCorner)
        }
    };
