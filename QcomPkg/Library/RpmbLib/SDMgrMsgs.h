...
/*=============================================================================
  ...
  ----------   ---     ---------------------------------------------------------
  2018-04-24   jt      Add new device types 
...
#include <Uefi.h>
#define  RPMB_DBG_LVL            EFI_D_INFO
...
typedef enum
{
  ...
  SD_MGR_SPINOR_ALL,              /**< Entire SPINOR device */
  SD_MGR_NVME_RPMB,               /**< RPMB Partition in NVMe device */
  SD_MGR_NVME_RPMB_EMU,           /**< Emulated RPMB Partition in SPINOR */
  SD_MGR_NVME_ALL,                /**< Entire NVMe device */
