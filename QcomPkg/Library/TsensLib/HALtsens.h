...
typedef enum
{
   HAL_TSENS_CAL_NOT_CALIBRATED,
   HAL_TSENS_CAL_OFFSET,
   HAL_TSENS_CAL_OFFSET_SLOPE,
   HAL_TSENS_CAL_SLOPE_OFFSET_TRUNCATED_3,
   HAL_TSENS_CAL_SLOPE_OFFSET_TRUNCATED_1,
