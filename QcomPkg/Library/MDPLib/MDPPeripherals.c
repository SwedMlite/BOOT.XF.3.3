                                       ...
                                       uint32                 uFlags)
{
  ...
  switch (eCommand)
  {
    ...
    {
      if (NULL != pI2CConfig->pI2CInitSequence)
      {
        eStatus = SendPanelXMLSequence(pI2CDriverCtx, pI2CConfig->pI2CInitSequence, pI2CConfig);
    ...
    case MDP_PANEL_COMMAND_CUSTOM:
    {
      if (NULL != pI2CConfig->pI2CInitSequence)
      {
        eStatus = SendPanelI2CSequence(pI2CDriverCtx, pI2CConfig->pI2CInitSequence, pI2CConfig);
