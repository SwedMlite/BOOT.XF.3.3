...
Copyright 2010-2018 by Qualcomm Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
--------   ---     ----------------------------------------------------------
04/19/18   daison  Added granule size to ram partition entry
...
)
{
        ...
        partition_index++)
  {
	...
	boot_ddr_get_granule_size(&granule_size, partition_index);
  	ram_part_entry_ptr->min_pasr_size = granule_size;
