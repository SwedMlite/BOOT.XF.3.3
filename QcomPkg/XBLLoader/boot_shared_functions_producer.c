...
boot_shared_functions_type shared_function_table;

boot_shared_functions_type * function_table = NULL;

boot_shared_functions_type * boot_get_shared_function_table(void)
{
  return &shared_function_table;
}
...
boot_shared_functions_register(void)
{
  ...
  boot_shared_functions_type * function_table = NULL;
  function_table = &shared_function_table;
  ...
  function_table->boot_log_get_time = &boot_log_get_time;
  function_table->boot_log_delta_time = &boot_log_delta_time;
  ...
  function_table->boot_pm_app_pon_debug_hard_reset = &boot_pm_app_pon_debug_hard_reset;  
  ...
  function_table->pm_lcdb_set_output_volt = &boot_pm_lcdb_set_output_volt;
  function_table->pm_lcdb_config_enable_ctrl = &boot_pm_lcdb_config_enable_ctrl;
  function_table->pm_lcdb_vreg_ok = &boot_pm_lcdb_vreg_ok;
                  
  function_table->pm_ldo_sw_enable = &boot_pm_ldo_sw_enable;
  function_table->pm_smps_sw_enable = &boot_pm_smps_sw_enable;
                  
  function_table->pm_ldo_volt_level = &boot_pm_ldo_volt_level;
  
  function_table->pm_smps_volt_level = &boot_pm_smps_volt_level;
  ...
  function_table->pm_wled_modulator_src_sel = &boot_pm_wled_modulator_src_sel;
  ...
  function_table->boot_PlatformInfo_IsFusion = &boot_PlatformInfo_IsFusion;
