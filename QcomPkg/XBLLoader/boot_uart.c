...
Copyright 2013, 2014, 2017, 2019 by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================*/
/*===========================================================================
...
--------   ---     ----------------------------------------------------------
09/03/19   yps     Check the BOOT_LOGGER_LOOP_MAGIC_NUM to disable UART
...
boolean boot_uart_init(void)
{
  ...
  do {
  	if((!uart_is_cable_connected()) || ((uint32)boot_shared_imem_cookie_ptr->etb_buf_addr == BOOT_LOGGER_LOOP_MAGIC_NUM))
	{
