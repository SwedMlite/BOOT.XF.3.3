...
Copyright 2005, 2006, 2010-2014, 2017, 2020 by Qualcomm Technologies Incorporated.
All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*===========================================================================
...
--------   ---     ----------------------------------------------------------
07/09/20   rakhi   Increased SCRIPT_BUF_SIZE to 32768
...
#define DDR_DUMP_REMAP_BASE (DDR_MEM_BASE_1 + (DDR_DUMP_SIZE_MB << CONVERT_TO_MB_SHIFT))
