...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  ...
  Copyright 2011-2012, 2014-2015,2017,2018 Qualcomm Technologies, Inc. All rights reserved.
...
--------   ---     ----------------------------------------------------------
07/06/18   yps     Add return value for heap functions
...
{
  return DALSYS_HeapInit(pHeapBase, dwHeapSz, dwInitType);
}
...
{
  return DALSYS_HeapDeInit(pHeapBase);
}
...
*/
int boot_DALSYS_HeapForceDeInit(void *pHeapBase) 
{
  return DALSYS_HeapForceDeInit(pHeapBase);
}
