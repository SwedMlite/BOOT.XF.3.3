...
Sl.No  Test command          Expected Results - WP       Description                            Expected results - LA
1     DepTest “-Alloc Code”  No crash; Test should pass  Trying to execute from code area, which is expected Should crash with “Instruction abort:” 
2     DepTest “-Alloc Data”  Should crash with “Instruction abort:”  Trying to execute from data area, should not be allowed Same as WP
3     DepTest  “-I DDRInfoTest.dll”   Should crash with “Data abort: “  Trying to overwrite existing code area, which is marked RO.   Same as WP
              OR DepTest  “-I FontDxe”
4     DepTest  “-A”          Should crash with “Data abort: “  Same as Case-3 above.                     Same as WP
