...
//============================================================================
/**
  Copyright (c) 2010-2011, 2017-2019 Qualcomm Technologies, Inc. All rights reserved.
...
typedef enum {
  ...
  CMD_ADVANCE_SS_CP         = 7,    // SS Advance Compliance Test Pattern
  ...
  )
{
  ...
  Print(L"  Test Modes:\n"
        ...
        L"     7  SS compliance advance test pattern: applicable only when SS compliance is enabled\n"       
        L"    10  Suspend\n"
        L"    11  Resume\n"
