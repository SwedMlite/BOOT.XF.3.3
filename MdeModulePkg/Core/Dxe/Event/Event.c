...
extern VOID PrintNotifyFnFileName ( IN  UINTN  NotifyFuncAddress );
#endif
///
  ...
  )
{
  ...
  while (!IsListEmpty (Head)) {
    ...
    {  
      PrintNotifyFnFileName((UINTN)Event->NotifyFunction);
    }
#endif
...
#if defined (QCOM_EDK2_PATCH) && defined (ENABLE_XN) && defined (ENABLE_EXEC_CODE_READY_TO_BOOT) && defined (ENABLE_DEP_64)
